...
br(),
        ...
        mainPanel(
           ...
           "1: Selecting Data",
           br(),
           "2: Selecting Behavior Stream Variable",br(),
           "3: Running Summary Prior to Manipulation", br(),
           "4: Choosing Manipulation",br(),
           "5: Looking at Summary Post Manipulation", br(),
           "6: Downloading Dataset for Export", br(),
           h3("Choosing Dataset"),
           "There are two options for selecting data. The user can choose there own data file (see 'Choose CSV') or can select
           one of the 6 illustrative datasets built in to the Reenforcinator Package",br(),
           h3("Selecting Behavior Stream"),
           "The Behavior stream contains all behavioral variables and is central to any of the data manipulation functions. Users click on the 'Select Behavior Stream' button
           and choose a variable from the list of columns, in the selected dataframe / data file.", br(),
           h3("Choosing Manipulation"),
           "There are three ways to manipulate the data: 1) deleting variables, 2) combining variables, 3) recoding partner variables.
           In order to perform a desired manipulation, the user must select the appropriate buttons, which represent the arguments to the corresponding functions in the Reenforincator R Package.",br(),
           h4("Deleting Variables"),
           "Deleting Variables requires:", br(),
           "1) Dataset",br(),
           "2) Behavior Stream", br(),
           "3) Variable for deletion",br(),
           h4("Combining Variables"),
           "Combining Variables requires:", br(),
           "1) Dataset", br(),
           "2) Behavior Stream", br(),
           "3) Variable for deletion",br(),
           h4("Partner Analysis"),
           "Combining Variables requires:",br(),
           "1) Dataset 2)",br(),
           "2) Behavior Stream Column", br(),
           "3) Partner Variable", br(),
           "4) Reinforcer", br(),
           "5) Partner Column",
           br()
        ) # end main panel
